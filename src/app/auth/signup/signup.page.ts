...
export class SignupPage implements OnInit {
   ...
   * Give the HTML form access to these fields to display error messages
   *
   * @returns the password confirmation form element
   */
  ...
  /**
   * Custom validation to ensure that the password confirmation matches the actual password
   *
   * @param matchTo the name of the form control to match to
   */
  ...
  /**
   * Register the user with the credentials they entered and navigate them to the main page
   */
  async register() {
